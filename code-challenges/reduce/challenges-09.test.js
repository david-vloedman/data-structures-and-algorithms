...
const countNumberOfElements = arr => arr.reduce((a, b, c, d) => c + 1);
...
const returnNames = arr => {
  let names = [];
  names.push(arr[0].name);
  arr.reduce((a, b) => names.push(b.name));
  return names;
};
...
const reversedString = str => [...str].reduce((a, b) => b + a);
...
const countNumberOfChildren = arr =>
  arr.reduce((a, b) => (b.children ? a + b.children.length : a), 0);
...
const countPrimeNumbers = arr =>
  arr.reduce((a, b) => (isPrime(b) ? a + 1 : a), 0);
